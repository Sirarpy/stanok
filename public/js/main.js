...
$('.dropdown-menu-li').mouseover(function(){
    $(this).children('.dropdown-sub-menu').show(250);
}).mouseleave(function(){
 $('.dropdown-sub-menu').hide(250);
})
...
if ($(window).width() < 768) {
  ...
  $('.dropdown-menu-li').click(function(){
    // alert("111");
    $(this).parent().removeClass('dropdown-menu').addClass('new-dropdown');
    $(this).children('.dropdown-sub-menu').show(250);
  })
}
...
function video(){
  $("#video-bg-elem").fadeOut(3000);
}
setTimeout(video, 9000);